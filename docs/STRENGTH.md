...
**6.1.1** is a compliance release: the internal mini-book is removed, license
texts and documentation added, strength untouched. No new gauntlet was run;
every figure below for 6.1.0 applies to 6.1.1 unchanged.
